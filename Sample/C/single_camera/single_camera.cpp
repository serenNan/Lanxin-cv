...
int main(int argc, char** argv)
{
    ...
    checkTC(DcSetBoolValue(handle, LX_BOOL_ENABLE_3D_DEPTH_STREAM, true));
    checkTC(DcSetBoolValue(handle, LX_BOOL_ENABLE_3D_AMP_STREAM, true));
    checkTC(DcSetBoolValue(handle, LX_BOOL_ENABLE_2D_STREAM, true));
